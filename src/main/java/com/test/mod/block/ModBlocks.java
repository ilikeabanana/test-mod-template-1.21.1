package com.test.mod.block;

import com.test.mod.TestMod;
import com.test.mod.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    private  static Block  registerBlock(String name, Block block){
        registBlockItem(name, block);
        return Registry.register(Registries.BLOCK, Identifier.of(TestMod.MOD_ID, name), block);
    }

    private static void registBlockItem(String name, Block block){
